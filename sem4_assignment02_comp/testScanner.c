...
* Purpose: run main and call structs to start buffer and scanner to read each char and print out results
*
* Function list: main(), printScannerError(), displayScanner(), getScannerFilesize(), printToken()
*/
...
/* __DATE__, __TIME__, __LINE__, __FILE__, __STDC__ are predefined preprocessor macros*/
	...
	do {
		...
		//printf("currentToken: %p", currentToken);
